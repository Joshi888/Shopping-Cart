...
$number = "/^[0-9]{0,10}+$/";
	...
	else
	{
		...
		if(!(strlen($mobile) == 10))
		{
			...
			<div class='alert alert-warning'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>Mobile No should be 10 digit</b>
			</div>
			";
			exit();
		}
		...
		if($count_email > 0)
		{
			...
			echo "<div class='alert alert-danger'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>This Email address is already registerd!! try another email</b>
					</div>
			";
			exit();
		}
			...
			if($run_query)
			{
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>You are registerd successfully</b>
					</div>		
				";
				exit();
			}
