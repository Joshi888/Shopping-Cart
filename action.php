				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:220px; height:210px;'>
								</div>
								<div class='panel-heading'><link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'>								
...
if(isset($_POST["get_selected_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"]))
{
	...
	{
		echo "<h4 align='center'>No Product Found.</h4>";
	}
}
	...
	if($count > 0)
	{
		...
		while($row = mysqli_fetch_array($run_query))
		{
			...
			else
			{
				...
				<div class='row'>
							...
							<div class='col-md-2'><img src='product_images/$pro_image' width='100px' height='90px'></div>
			...
			echo "
				<div class='row'>
							<div class='col-md-10'></div>
								<div class='col-md-2'>
									<h4>Total:- <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'>
										<i class='fa fa-inr' aria-hidden='true'></i>
									$total_amt</h4>
								</div>
				</div>
		...
		echo '
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
  			...
  			<input type="hidden" name="business" value="shoppingcart12358@gmail.com">
  			...
  			echo '
			<input type="hidden" name="return" value="http://www.civicart.ml/payment_success.php"/>
			<input type="hidden" name="cancel_return" value="http://www.civicart.ml/cancel.php"/>
			<input type="hidden" name="currency_code" value="USD"/>
			<input type="hidden" name="custom" value="'.$uid.'"/>
  			<input style="float:right;" type="image" name="submit"
    		src="http://paypalobjects.com/webstatic/en_US/i/btn/png/blue-rect-paypalcheckout-60px.png" alt="PayPal Checkout"
...
if(isset($_POST["updateProduct"]))
{
	...
	if($run_query)
	{
		echo "
			<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Product Is Upadted Successfully</b>
			</div>
		";
	}
}	
